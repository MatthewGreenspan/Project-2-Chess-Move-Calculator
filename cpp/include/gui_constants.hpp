...
inline constexpr Uint32 COLOR_BG = 0x1a1a2eff;
inline constexpr Uint32 COLOR_SURFACE = 0x16213eff;
...
inline constexpr Uint32 COLOR_ACCENT = 0x0f3460ff;

inline constexpr const char* PIECE_NAMES[] = {"king", "queen", "rook", "bishop", "knight", "pawn"};
inline constexpr const char* PIECE_NAMES_CAP[] = {"King", "Queen", "Rook", "Bishop", "Knight", "Pawn"};
